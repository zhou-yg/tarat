...
`
async function generateReferrenceHooks (c: IConfig, h: IDependencyHook[]) {
...
export async function composeHook(c: IConfig) {
  const dependencyHooks: IDependencyHook[] = []
